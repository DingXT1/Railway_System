...
module seg_dtxs(
    ...
    //////////////////////////////////////////////
    input [15:0]  refer_money,   //参考金额【8+8】
    ...
    always @(posedge clk) begin
        case (num)
            ...
            4: begin
                ...
                if(top_state == 4'b0001)begin seg_value = refer_money[7:0];end
                else begin seg_value = 8'b1111_1001; end
               end// 赋值相应内容
            5: begin 
                seg_sel= 8'b1111_1011;
                if(top_state == 4'b0001)begin seg_value = refer_money[15:8];end
                else begin seg_value = 8'b1111_1001; end
               end
            6: begin seg_sel= 8'b1111_1101;seg_value = 8'b1111_1001;  end// 赋值相应内容
            7: begin seg_sel= 8'b1111_1110;seg_value = 8'b1111_1001; end           
            //原则上不会执行
