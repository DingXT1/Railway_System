    ...
    always @(posedge clk) begin
        case (num)
            0: begin 
                ...
                ///////////////////////////////////////////////
                //状态2
                if(top_state==4'b0010)begin seg_value = price_hand_show[7:0]; end
                //状态0
                else begin seg_value = start_station[7:0];  end 
                //////////////////////////////////////////////
               end
            1: begin 
                ...
                ///////////////////////////////////////////////
                //状态2
                if(top_state==4'b0010)begin seg_value = price_hand_show[15:8]; end
                //状态0
                else begin seg_value = start_station[15:8];  end 
                ////////////////////////////////////////////// 
               end
            2: begin 
                ...
                ///////////////////////////////////////////////
                //状态2
                if(top_state==4'b0010)begin seg_value = ticket_hand_show[7:0]; end
                //状态0
                else begin seg_value = end_station[7:0];  end 
                ////////////////////////////////////////////// 
            end
            3: begin 
                ...
                ///////////////////////////////////////////////
                //状态2
                if(top_state==4'b0010)begin seg_value = ticket_hand_show[15:8]; end
                //状态0
                else begin seg_value = end_station[15:8];  end 
                //////////////////////////////////////////////
               end
